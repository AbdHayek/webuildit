...
export default function index() {
  ...
  {steps.map((step, index) => (
    ...
    >
      <div className="relative w-full max-w-[90%] sm:max-w-[320px] lg:max-w-[360px]">
        {/* Top Left Corner Border (hidden on small screens) */}
        <div
        ...
        {/* Bottom Right Corner Border (hidden on small screens) */}
        <div
        ...
        {/* Step Box */}
        <div className="flex gap-4 sm:gap-5 bg-[#180F37] border border-[#180F37] text-left p-4 rounded-lg w-full">
          <div className="flex-1">
            <h4 className="text-base sm:text-lg font-bold">{step.title}</h4>
      ...
      {/* Line connector (show only on md+) */}
      {(index === 0 || index === 3) && (
        <div className="hidden md:block text-purple-600 absolute left-[79%] top-0 bottom-0">
          <svg width="400" height="400" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M 0 50 H 80 C 120 50, 120 150, 160 150" stroke="#2E1158" strokeWidth="3" fill="none" />
          </svg>
        </div>
      )}

      {index === 2 && (
        <div className="hidden md:block text-purple-600 absolute top-[100%] left-[0%] rotate-90">
          <svg width="400" height="400" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M 0 50 H 80 C 120 50, 120 150, 160 150" stroke="#2E1158" strokeWidth="3" fill="none" />
          </svg>
        </div>
      ...
      {(index === 1 || index === 4) && (
        <div className="hidden md:block text-purple-600 absolute left-[40%] top-[-47%]">
          <svg width="400" height="400" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
