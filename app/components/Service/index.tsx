...
const servicesData = [
  ...
  {
    title: "UI/UX DESIGN",
    description: "Creating seamless user experiences through wireframing & prototyping",
  ...
  },
  {
    ...
    description: "Helping businesses shape their tech roadmap and digital transformation",
  ...
  return (
    <section className="bg-gradient-to-b from-[#070322] to-[#070322] text-white py-16 px-4 md:px-20">
      ...
      {servicesData.map((service, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-row items-center md:justify-between border-b border-[#3f2a74] py-12 px-[5%]"
        >
          {/* Text Content */}
          ...
          <div className="md:w-1/2 flex justify-center">
            <Image src={service.image} width={300} height={300} alt={service.imageAlt} className="w-80" />
          </div>
        </div>
      ))}
    </section>
